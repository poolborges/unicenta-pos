...
public class KriolosPosMachine {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" CPU(s): " + cpu.getLogicalProcessorCount());
        ...
        System.out.println("Network Gateway (IPv4): " + ntP.getIpv4DefaultGateway());
        System.out.println("Network Gateway (IPv6): " + ntP.getIpv6DefaultGateway());
