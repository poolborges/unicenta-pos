...
image:https://github.com/poolborges/unicenta-pos/actions/workflows/ci.yml/badge.svg["Build Status", link="https://github.com/poolborges/unicenta-pos/actions/workflows/build.yml"]
