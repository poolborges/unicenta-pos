...
KrOS POS v4.5 includes bug-fixes.

Please read the unicentaopos_4.5_readme in the Release Notes folder.

Java JRE 8 runtime is required.
The KrOS POS installer now attempts to validate that Java JRE runtime is 
...
when trying to run KrOS POS. This is usually caused by having selected
...
Select the :\Windows\System32 JRE during KrOS POS installation OR
